...
if __name__ == '__main__':
    ...
    # if 'yes' in useropt or 'sure' in useropt: quotaton()
    # else:
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            webbrowser.open("https://open.spotify.com/album/3nzuGtN3nXARvvecier4K0")
        ...
        #     exit()
            ...
            speak("I have been created by shantanu.")
         ...
         speak(pyjokes.get_joke())
            ...
            speak("Thanks to Shantanu. further It's a secret")

        elif 'is love' in query:
            speak("It is 7th sense that destroy all other senses")

        elif "who are you" in query:
            speak("I am your virtual assistant created by Shantanu")

        elif 'reason for you' in query:
            speak("I was created as a Minor project by Mister Shantanu ")
        ...
        #     os.startfile(appli)
            ...
            ec.capture(0,"Mini Camera ","img.jpg")
            ...
            wishMe()
            speak("Mini 1 point o in your service Mister")
            speak(assname)
        ...
        elif "open Gmail" in query or "mail" in query:
